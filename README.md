...
[![Binder](https://mybinder.org/badge_logo.svg)](https://mybinder.org/v2/gh/Code-Inspect/binder-flowR/flowr-enabled?urlpath=rstudio)

🚀 **Click below to launch the project on the NFDI JupyterHub:**  
[![NFDI](https://nfdi-jupyter.de/images/nfdi_badge.svg)](https://hub.nfdi-jupyter.de/r2d/gh/Code-Inspect/binder-flowR/flowr-enabled?urlpath=rstudio)
